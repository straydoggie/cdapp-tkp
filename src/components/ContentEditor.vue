                    ...
                    <div class="modal-content modal-container">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-12 btn-group">
                                    ...
                                    <button
                                        type="button"
                                        class="btn border btn-primary border-primary"
                                    >填空</button>
                                    <button
                                        type="button"
                                        class="btn border"
                        ...
                        <div class="modal-footer">
                            <button
                                ...
                                @click="saveCurrent('again')"
                            >继续添加</button>
                            <button
                                type="button"
                                class="btn btn-primary"
                                @click="saveCurrent('add')"
                            >添加</button>
                            <button
                                type="button"
...
import ContentEditorTree from "@/components/ContentEditorTree.vue";
...
export default {
    ...
    methods: {
        ...
        validCurrent: function() {
            //验证数据有效性
            if (
                this.currentStreamList.length * this.currentAnswers.length ==
                0
            ) {
